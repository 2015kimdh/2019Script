...
class MainFrame:
    ...
    def InitSearchEntry(self):
        ...
        # 시·군 입력 엔트리
        self.sigunEntry = Entry(self.frame, font=self.TempFont, width=26, borderwidth=12, relief='ridge')
        self.sigunEntry.place(x=self.width * 0.2, y=self.height / 10 * 7)

        # 동 단위 입력 엔트리
        self.dongEntry = Entry(self.frame, font=self.TempFont, width=26, borderwidth=12, relief='ridge')
